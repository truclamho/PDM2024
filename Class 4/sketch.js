...
function setup() {
  ...
  // face = new Face(200, 150, color('blue'));
...
function draw() {
    ...
    for(let i=0; i < faces.length; i++) {
      faces[i].draw();    // calling draw function from each face
    }
...
class Face {
  ...
  contains(x, y) {
    ...
    return insideX && insideY; //return true if inside x and y is true otherwise itwill return false
  }
}
